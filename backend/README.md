...
## Project Structure
    ...
    ├── testapplliiccaattii_46702  # Django project configurations
...
1. Clone this repo and `cd testapplliiccaattii_46702`
...
2. Clone this repo and `cd testapplliiccaattii_46702`
